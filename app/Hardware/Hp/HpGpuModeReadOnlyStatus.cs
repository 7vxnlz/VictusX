    ...
    bool? ModeChangeRequiresReboot)
{
    ...
    {
        HpGpuModeAvailability.SupportedStateUnavailable => "GPU Mode: Supported, state unavailable",
        HpGpuModeAvailability.NotSupported => "GPU Mode: Not supported",
        _ => "GPU Mode: Unavailable"
    };
