...
- NvAPIWrapper.Net distribution method: **Pending**. The LGPL/GPL texts and attribution are present, but self-contained single-file combined-work/relinking compliance has not been approved.
