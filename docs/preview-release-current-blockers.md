...
| Third-party/license notices status | Blocked | Runtime license identities are evidenced, but required license texts/notices are not assembled, upstream/package review is incomplete, and Microsoft.Management.Infrastructure.Runtime.Win 3.0.0 is not cleared for VictusX distribution. | [Runtime dependency review](runtime-dependency-license-review.md), [Package notices plan](package-license-third-party-notices-completion-plan.md) |
| Runtime dependency license review | Done | Source-level identity/version/license evidence is recorded for all eight direct and three transitive packages in the current restore graph. Artifact presence remains a separate final inspection step. | [Runtime dependency review](runtime-dependency-license-review.md) |
| Runtime dependency release disposition | Blocked | Microsoft.Management.Infrastructure.Runtime.Win 3.0.0 uses custom terms restricting use to PowerShell and prohibiting redistribution. Exclude/replace it or obtain an authoritative clearance before packaging. | [Runtime dependency review](runtime-dependency-license-review.md) |
| `THIRD-PARTY-NOTICES.md` release readiness | Blocked | The source-level draft now records evidenced licenses, but required MIT, Apache-2.0/NOTICE, and LGPL-3.0/GPL-3.0 materials, restrictive-license disposition, icon attribution, and final artifact matching remain open. | [Third-Party Notices draft](../THIRD-PARTY-NOTICES.md) |
...
- Microsoft.Management.Infrastructure.Runtime.Win 3.0.0 excluded/replaced or authoritatively cleared for VictusX distribution.
